...
#                                          name                       description                          cmd           bytes       decoder              ECU          fast
    ...
    'BAT_PACK_CAP_AH_EST_2018':       OBDCommand("BAT_PACK_CAP_KWH_EST_2018",          "Battery Capacity KWh Est 2017 - 2018"          , b"2241a3"     ,  0, bat_ah_raw_2018, ECU.ALL    , False),  
    'BAT_PACK_CAP_AH_EST_2019':       OBDCommand("BAT_PACK_CAP_KWH_EST_2019",          "Battery Capacity KWh Est 2019+"                , b"2245f9"     ,  0, bat_ah_raw_2019, ECU.ALL    , False),  
    'BAT_PACK_SOC_DISP':       OBDCommand("BAT_PACK_SOC_DISP",          "Battery SoC Displayed"          , b"228334"    ,  0, bat_soc, ECU.ALL    , False),  
