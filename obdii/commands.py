...
#                                          name                       description                          cmd           bytes       decoder              ECU          fast
    ...
    'BAT_PACK_SOC_RAW_LD':            OBDCommand("BAT_PACK_SOC_RAW_LD",                 "Battery SoC Raw LD"                             , b"015b"     ,  0, bat_soc_raw_ld,      ECU.ALL    , False), 
    'BAT_PACK_SOC_RAW_LD2':            OBDCommand("BAT_PACK_SOC_RAW_LD2",                 "Battery SoC Raw LD2"                             , b"222411"     ,  0, bat_soc_raw_ld2,      ECU.ALL    , False), 
    'BAT_PACK_SOC_RAW_LD3':            OBDCommand("BAT_PACK_SOC_RAW_LD3",                 "Battery SoC Raw LD3"                             , b"22432f"     ,  0, bat_soc_raw_ld3,      ECU.ALL    , False), 
